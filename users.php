...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <?php if(isset($_SESSION['succes_add_user'])):?>
                <div class="alert alert-success">
                <?php display_flash_message('succes_add_user');?>
                </div>
            <?php endif;?>
            <?php if(isset($_SESSION['succes_update_user'])):?>
                <div class="alert alert-success">
                <?php display_flash_message('succes_update_user');?>
                </div>
            <?php endif;?>
            <div class="subheader">
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <a href="profile.php?id=<?= $user['id']?>"><span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?= $user['image_name'] ?? 'avatar-m.png'; ?>'); background-size: cover;"></span></a>
            ...
            <?php endforeach; ?>
            <?php elseif($_SESSION['user']['status'] != 'admin'): ?>
                <div class="col-xl-4">
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <a href="profile.php?id=<?= $_SESSION['user']['id']?>"><span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?= $_SESSION['user']['image_name']; ?>'); background-size: cover;"></span></a>
                                ...
                                <div class="info-card-text flex-1">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit.php?id=<?= $_SESSION['user']['id']?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="security.php?id=<?= $_SESSION['user']['id']?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status.php?id=<?= $_SESSION['user']['id']?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="media.php?id=<?= $_SESSION['user']['id']?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete_user.php" class="dropdown-item" onclick="return confirm('are you sure?');">
                                            <i class="fa fa-window-close"></i>
                                            Удалить
                                        </a>
                                    </div>
                                    <span class="text-truncate text-truncate-xl"><?= $_SESSION['user']['job_title']; ?></span>
                                </div>
                                <button class="js-expand-btn btn btn-sm btn-default d-none" data-toggle="collapse" data-target="#c_1 > .card-body + .card-body" aria-expanded="false">
                                    <span class="collapsed-hidden">+</span>
                                    <span class="collapsed-reveal">-</span>
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i> <?= $_SESSION['user']['phone'];?></a>
                                <a href="mailto:oliver.kopyov@smartadminwebapp.com" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mouse-pointer text-muted mr-2"></i> <?= $_SESSION['user']['email'];?></a>
                                <address class="fs-sm fw-400 mt-4 text-muted">
                                    <i class="fas fa-map-pin mr-2"></i> <?= $_SESSION['user']['adress'];?></address>
                                <div class="d-flex flex-row">
                                    <a href="<?= $_SESSION['user']['vk'];?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                        <i class="fab fa-vk"></i>
                                    </a>
                                    <a href="<?= $_SESSION['user']['telegram']; ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                        <i class="fab fa-telegram"></i>
                                    </a>
                                    <a href="<?= $_SESSION['user']['instagram'];?>" class="mr-2 fs-xxl" style="color:#E1306C">
                                        <i class="fab fa-instagram"></i>
                                    </a>
                                </div>
                            </div>
